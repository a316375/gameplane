...
//
//    public ShuiEffect_copy(GifObj obj, GifAllBitmaps allBitmaps) {
...
//                shuiBag = (ShuiBag) new ShuiBag_copy(gifObj,list).withShowTime(showTime);
//
