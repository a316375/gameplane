...
import xyxgame.gameplane.schoolGif.Enemy.gk02.shui.UpxiongGifBoss;
...
public class Gk02 {
    ...
    public UpxiongGifBoss upxiongGifBoss;
...
//        }
        ...
        if (upxiongGifBoss !=null) upxiongGifBoss.drawCanvas(canvas);
