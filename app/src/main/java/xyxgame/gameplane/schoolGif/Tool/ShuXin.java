...
public class ShuXin {
    public static final String WEB_ID = "835339244977-o5ia47pj7ggqpf1cha2dhlivi5pk09nu.apps.googleusercontent.com";
    public static int Jin=1,Mu=2,Shui=3,Huo=4,Tu=5,Boss=6,Null=-1,Speed=2;
